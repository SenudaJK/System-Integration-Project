...
export default function FuelEntryScreen({ route, navigation }) {
  ...
  const processFuelDispense = async () => {
    ...
    try {
      ...
      const response = await apiService.recordFuelTransaction(transactionData);
      ...
      Alert.alert(
        'Transaction Failed',
        error.response?.data?.message || 'Failed to process fuel transaction. Please try again.'
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Enter fuel amount to dispense</Text>
      </LinearGradient>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Animated.View style={animatedStyle}>
          ...
          <View style={styles.vehicleCard}>
            <View style={styles.vehicleHeader}>
              ...
              <View style={styles.vehicleInfo}>
                ...
                <Text style={styles.vehicleType}>{vehicleData.vehicleType}</Text>
              </View>
              <View style={styles.ownerInfo}>
                <Text style={styles.ownerName}>{vehicleData.owner.firstName} {vehicleData.owner.lastName}</Text>
                <Text style={styles.ownerNic}>{vehicleData.owner.nic}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.formCard}>
            <Text style={styles.formTitle}>Fuel Dispense Details</Text>
            
            {/* Fuel Amount Input */}
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Fuel Amount (Liters)</Text>
              <View style={[styles.inputContainer, errors.fuelAmount && styles.inputError]}>
              ...
              {errors.fuelAmount && (
                <Text style={styles.errorText}>{errors.fuelAmount}</Text>
              )}
            </View>

            {/* Remaining Quota Display */}
            <View style={styles.quotaDisplay}>
              <Text style={styles.quotaDisplayLabel}>Remaining Quota After Dispense:</Text>
              <Text style={[
                styles.quotaDisplayValue,
                getRemainingQuota() < 10 && styles.quotaDisplayWarning
              ]}>
            ...
            <TouchableOpacity
              style={[
                ...
                (!fuelAmount || errors.fuelAmount) && styles.dispenseButtonDisabled
              ]}
            ...
            >
              ...
              >
                ...
                <Text style={styles.dispenseButtonText}>Dispense Fuel</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
